    ...
    return (
      <TouchableWithoutFeedback
        ...
        <View
          ...
          {this.state.selected ?<Text>this.state.selected</Text>
          :<Text>this.state.ssssselected</Text>} */}
          <View style={{alignSelf:'center',marginVertical:10}}>
          <AddressListCard  selected={this.state.selected} displayValue={this.props.displayValue}/>
