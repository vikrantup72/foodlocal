...
import { FontFamily } from "../../reusableComponents/Constants.js";

const multipleGroupData = [
  { value: "1", displayValue: "south-indian" },
  { value: "2", displayValue: "itaian" },
  { value: "3", displayValue: "Chinease" },
...
const defaultSelectedIndex_group_insterest = [];
...
export default class GroupButton extends Component {
      ...
      <View style={{ flex: 1, }}>
        ...
        <SelectMultipleGroupButton
          ...
          highLightStyle={{
            ...
            backgroundColor: "#fff",
            textColor: "#000",
            borderTintColor: "#972C26",
            backgroundTintColor: "#972C26",
            textTintColor: '#fff',
  ...
  _groupButtonOnSelectedValuesChange(selectedValues) {
    console.warn('selectedValues',selectedValues)
    this.setState({
